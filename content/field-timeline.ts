...
export const timelineEvents: TimelineEvent[] = [
  ...
  { id: "event-heat-science-video", capturedAt: "2026-08-03 21:18", day: "2026-08-03", category: "科普", storyPointId: "base-activity-center", mediaId: "heat-science-video", locationAccuracy: "GPS实拍点", note: "活动影像不构成医学诊疗建议。" },
  ...
  { id: "event-live-melon-still", capturedAt: "2026-08-03", timeLabel: "8月3日深夜", day: "2026-08-03", category: "传播", storyPointId: "base-activity-center", mediaId: "live-melon-still", locationAccuracy: "GPS实拍点", note: "记录直播助农尝试，不展示账号、订单或销量。" },
