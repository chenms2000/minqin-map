...
const timelineEventCatalog: TimelineEvent[] = [
  ...
  { id: "event-fruit-picking", capturedAt: "2026-08-03 19:54", day: "2026-08-03", category: "观察", storyPointId: "desert-observation", mediaId: "fruit-picking", locationAccuracy: "GPS实拍点", note: "队员观察白刺果实分布与枝条状态后进行采摘，并同步记录植株和周边沙地环境。" },
  ...
  { id: "event-live-melon-still", capturedAt: "2026-08-03", timeLabel: "8月3日深夜", day: "2026-08-03", category: "传播", storyPointId: "base-activity-center", mediaId: "live-melon-still", locationAccuracy: "GPS实拍点", note: "记录队员以直播画面介绍当地哈密瓜的传播尝试。" },
  { id: "event-live-melon-video", capturedAt: "2026-08-03", timeLabel: "8月3日深夜", day: "2026-08-03", category: "传播", storyPointId: "base-activity-center", mediaId: "live-melon-video", locationAccuracy: "GPS实拍点", note: "隐私裁剪画面只保留人物与哈密瓜。" },
