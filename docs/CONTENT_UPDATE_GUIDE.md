...
在 `content/field-timeline.ts` 添加 `TimelineEvent`。日期时间、类别、媒体、点位和定位精度必须齐全。没有 GPS 时使用“县域叙事点”或“村级近似定位”，不要生成虚假移动轨迹。
...
- 无法确认的植物写“沙生植物观察”，不得擅自鉴定。

收到正式经纬度后，可更新坐标和精度说明；在此之前，公益林基地保持“收成镇兴隆村村级近似定位”。
